  ...
  return (
    <header style={{
      ...
      <a href="#top" onClick={(e) => { e.preventDefault(); scrollTo({ top: 0, behavior: 'smooth' }); }}
        style={{
          fontFamily: 'var(--font-mono)', fontWeight: 'var(--fw-medium)', fontSize: 'var(--text-label)',
          ...
          transition: 'opacity var(--dur-3) var(--ease-out), transform var(--dur-3) var(--ease-out), color var(--dur-3) var(--ease-soft)'
        }}>RS</a>
...
function ThemeToggle({ muted, fg }) {
  ...
  return (
    <button onClick={toggle} onMouseEnter={() => setH(true)} onMouseLeave={() => setH(false)} aria-label="Toggle theme"
      style={{
        display: 'flex', alignItems: 'center', gap: '0.5rem', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-micro)',
      ...
      <span style={{
        width: 6, height: 6, borderRadius: '999px', background: dark ? 'var(--accent-2)' : 'var(--accent)',
...
function NavLink({ label, muted, fg, onClick }) {
  ...
  return (
    <button onClick={onClick} onMouseEnter={() => setH(true)} onMouseLeave={() => setH(false)}
      style={{
        position: 'relative', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-label)',
      ...
      {label}
      <span style={{
        position: 'absolute', left: 0, bottom: 0, height: 'var(--hair)', width: '100%',
    ...
    <section ref={wrap} style={{
      ...
      <div aria-hidden="true" style={{ position: 'absolute', inset: '-10%', zIndex: -2, overflow: 'hidden', pointerEvents: 'none' }}>
        <div className="wave" style={{
          position: 'absolute', top: '-14%', right: '-4%', width: '62vw', height: '62vw',
        ...
        <div className="wave" style={{
          position: 'absolute', bottom: '-22%', left: '-10%', width: '60vw', height: '60vw',
        ...
        <div className="wave" style={{
          position: 'absolute', top: '16%', left: '22%', width: '46vw', height: '46vw',
      ...
      <div aria-hidden="true" className="hero-orb" style={{
        position: 'absolute', bottom: '-17vh', right: '-9vh',
      ...
      <Reveal as="div" delay={window.isInitialLanding ? 1480 : 100} style={{
      ...
      <div style={{
        transform: 'translate(var(--px,0), var(--py,0))', transition: 'transform var(--dur-3) var(--ease-soft)',
        display: 'flex', alignItems: 'flex-end', gap: 'clamp(1.25rem,4vw,4.5rem)', flexWrap: 'wrap'
      }}>
        <h1 style={{
          fontFamily: 'var(--font-display)', fontWeight: 'var(--fw-light)', fontSize: 'clamp(3.5rem, 9.5vw, 9.5rem)',
          lineHeight: 'var(--leading-hero)', letterSpacing: 'var(--track-hero)', textTransform: 'uppercase',
          color: 'var(--text-strong)', margin: 0
        }}>
          <span className="hero-line"><span className="hero-line-in" style={{ animationDelay: window.isInitialLanding ? '1.55s' : '0.15s' }}>Rapheal</span></span>
          <span className="hero-line" style={{ marginLeft: 'clamp(1.5rem,7vw,7rem)' }}><span className="hero-line-in" style={{ animationDelay: window.isInitialLanding ? '1.70s' : '0.30s' }}>Suber</span></span>
        </h1>
        <Reveal as="ul" delay={window.isInitialLanding ? 2250 : 400} style={{
          listStyle: 'none', margin: '0 0 0.7em', padding: 0,
      ...
      <Reveal delay={window.isInitialLanding ? 1900 : 250} y="12px" style={{
        borderTop: 'var(--hair) solid var(--border)', paddingTop: '1.4rem',
        display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 'clamp(2rem,6vw,6rem)', flexWrap: 'wrap'
      }}>
        <p style={{
          margin: 0, maxWidth: '42ch', fontSize: 'var(--text-body-lg)', lineHeight: 'var(--leading-body-lg)',
        ...
        <span style={{
          display: 'flex', alignItems: 'center', gap: '0.6rem', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-micro)',
...
function CaseRow({ item, last }) {
  ...
  return (
    <a data-hot href={`${item.id}.html`} onMouseEnter={() => setH(true)} onMouseLeave={() => setH(false)}
      style={{
        position: 'relative', width: '100%', textAlign: 'left', display: 'block',
      ...
      <div style={{
        ...
        <span style={{
          ...
          color: h ? 'var(--accent)' : 'var(--text-faint)', alignSelf: 'start', paddingTop: '0.5rem', transition: 'color var(--dur-2) var(--ease-soft)'
        }}>{item.code}</span>
        <span style={{ minWidth: 0 }}>
          <span style={{
            display: 'block', fontFamily: 'var(--font-display)', fontWeight: 'var(--fw-light)', fontSize: 'var(--text-h1)',
            lineHeight: 0.98, letterSpacing: 'var(--track-tight)', color: 'var(--text-strong)', transform: h ? 'translateX(0.4rem)' : 'none',
            transition: 'transform var(--dur-3) var(--ease-out)'
          }}>{item.title}</span>
          <span style={{
            display: 'block', marginTop: '0.7rem', fontFamily: 'var(--font-mono)', fontSize: 'var(--text-micro)',
            letterSpacing: 'var(--track-label)', textTransform: 'uppercase', color: 'var(--text-muted)',
            transform: h ? 'translateX(0.4rem)' : 'none', transition: 'transform var(--dur-3) var(--ease-out) 30ms'
          }}>{item.disciplines.join('  ·  ')}</span>
        </span>
        <span aria-hidden="true" style={{
          width: 'clamp(6rem,11vw,11rem)', height: 'clamp(4.5rem,8vw,8rem)', flexShrink: 0,
        ...
        <span style={{ display: 'flex', alignItems: 'center', gap: 'clamp(1rem,2vw,2rem)', alignSelf: 'start', paddingTop: '0.4rem' }}>
          ...
          <span aria-hidden="true" style={{
            fontFamily: 'var(--font-mono)', fontSize: '1.2rem', color: h ? 'var(--accent)' : 'var(--text-muted)',
            transform: h ? 'translateX(6px)' : 'none', transition: 'transform var(--dur-3) var(--ease-out), color var(--dur-2) var(--ease-soft)'
          }}>→</span>
        </span>
      </div>
    </a>
